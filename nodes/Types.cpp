...
std::string simpleExpr1ToString(SimpleExpr1Type t) {
    switch (t) {
        ...
        default:                       return "Unknown simple expr1 type";
    }
}
...
std::string simpleExprToString(SimpleExprType t) {
    switch (t) {
        ...
        default:                 return "Unknown simple expr type";
    }
}
...
std::string stableIdTypeToString(StableIdType t) {
    switch (t) {
        ...
        default:                                return "Unknown stable id type";
    }
}
...
std::string prefixExprToString(PrefixExprType t) {
    switch (t) {
        ...
        default: return "Unknown prefix expr";
    }
}
...
std::string classParamTypeToString(ClassParamType t) {
    switch (t) {
        ...
        default:                    return "Unknown class param type";
    }
}
...
std::string classEnumCaseTypeToString(EnumCaseType t) {
    switch (t) {
        ...
        default:                 return "Unknown class enum case type";
    }
}
...
std::string classExtensionTemplateTypeToString(ClassExtensionTemplateType t) {
    switch (t) {
        case _PARENT_CONSTR_CALL_AND_THIS_BODY: return "If Else";
        case _PARENT_CONSTR_CALL:               return "If";
        case _ONLY_PARENT_ID:                   return "While";
        case _THIS_BODY:                        return "Try";
