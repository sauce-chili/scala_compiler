...
public:
    ...
    /**
     * Возвращает JVM-дескриптор типа.
     * Нужен конкретно для конструкторов примитивов из rtl (например, для корректного создания объектов типа Int, Char и т.д.)
     */
    string toConstructorArgDescriptor(string className) const;
